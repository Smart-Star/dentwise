...
import { CalendarIcon, Dot, MicIcon } from "lucide-react";
...
export function CTA() {
  return (
    <div
      ...
      <section className='grid lg:grid-cols-2 gap-12 items-center relative z-10 max-w-6xl mx-auto'>
        {/* Left Content */}
          ...
          <div className='relative'>
            ...
            <div className='absolute -top-4 left-4 bg-linear-to-r from-green-500/90 to-emerald-500/90 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg z-10'>
              <div className='flex items-center gap-1'>
                <Dot className='size-1.5 bg-white rounded-full animate-pulse' />
                Available 24/7
              </div>
            </div>
            ...
            <div className='relative'>
              {/* Subtle glow */}
              <div className='absolute inset-0 bg-linear-to-br from-primary/10 to-transparent rounded-2xl blur-xl scale-110' />
              <Image
                src='/cta.png'
            ...
            {/* Decorative Elements */}
            <div className='absolute -bottom-2 -right-2 w-16 h-16 bg-linear-to-br from-primary/10 to-primary/5 rounded-full blur-lg' />
          </div>
        </div>
      </section>
    </div>
